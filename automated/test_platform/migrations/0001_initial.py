    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_name', models.CharField(max_length=32, verbose_name='设置名称')),
                ('set_value', models.CharField(max_length=128, verbose_name='设置值')),
                ('platform_name', models.CharField(max_length=64, verbose_name='平台名称')),
                ('platform_version', models.CharField(max_length=32, verbose_name='平台版本')),
                ('device_name', models.CharField(max_length=64, verbose_name='设备名称')),
                ('app', models.CharField(max_length=256, verbose_name='APP路径')),
                ('no_reset', models.BooleanField(max_length=16, verbose_name='是否重启')),
                ('reset_key_board', models.BooleanField(max_length=16, verbose_name='重置键盘')),
                ('unicode_key_board', models.BooleanField(max_length=16, verbose_name='unicode键盘')),
                ('recreate_charome_driver_sessions', models.BooleanField(max_length=16, verbose_name='启动charomedriver')),
            ],
        ),
        migrations.AddField(
            model_name='modules',
