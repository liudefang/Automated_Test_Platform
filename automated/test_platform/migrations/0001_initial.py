...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('apitest_name', models.CharField(max_length=128, verbose_name='接口名称')),
                ('apiurl', models.CharField(max_length=256, verbose_name='URL地址')),
                ('apiparamvalue', models.CharField(max_length=1024, verbose_name='请求参数和值')),
                ('apimethod', models.CharField(choices=[('get', 'get'), ('post', 'post'), ('put', 'put'), ('delete', 'delete'), ('patch', 'patch')], default='get', max_length=64, null=True, verbose_name='请求方法')),
                ('apiresult', models.CharField(max_length=256, verbose_name='预期结果')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('appcase_name', models.CharField(max_length=256, verbose_name='用例名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('appcase_name', models.CharField(max_length=256, verbose_name='测试用例标题')),
                ('apptestsetp', models.CharField(max_length=256, verbose_name='测试步骤')),
                ('apptestobj_name', models.CharField(max_length=256, verbose_name='测试对象名称描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('webcase_name', models.CharField(max_length=256, verbose_name='用例名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('webcase_name', models.CharField(max_length=256, verbose_name='测试用例标题')),
                ('webtest_setp', models.CharField(max_length=256, verbose_name='测试步骤')),
                ('webtestobj_name', models.CharField(max_length=256, verbose_name='测试对象名称描述')),
